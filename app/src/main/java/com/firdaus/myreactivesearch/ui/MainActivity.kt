package com.firdaus.myreactivesearch.ui
...
import com.firdaus.myreactivesearch.R
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // code untuk mengirim query ketika form diisi
        ...
        // mengambil hasil pencarian dari model dan di tampilkan di AutoCompleteTextView
